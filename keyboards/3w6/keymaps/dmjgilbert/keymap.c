...
enum layers { _DAZMAK, _SYMBOL, _NAVIG };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOL] = LAYOUT(
        ...
        //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                       KC_LGUI, _______,  KC_SPC,     KC_DEL, _______, _______
                                   //`--------------------------'  `--------------------------'
    ),
    ...
    [_NAVIG] = LAYOUT(
        ...
        //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                       KC_LALT, _______,  KC_TAB,    LT_BSPC, _______, _______
                                   //`--------------------------'  `--------------------------'
    ),
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
    switch (get_highest_layer(state)) {
        case _SYMBOL:
            pimoroni_trackball_set_rgbw(0, 193, 173,0);
